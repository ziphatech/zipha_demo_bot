const groupInfo = {
  ...
  <strong>Welcome to the  section! please make sure you read the terms and condition properly before proceeding to make a payment.</strong>
  
  <code>Terms and conditions VIP</code>
  
  <code>All information on how to manage the trades will be given, e.g SL, TP, when to cut losses, when to breakeven (B.E), when to take partials and other things that will help become profitable become profitable with our signal service.</code>
  ...
    WE TRADE ONLY XAUUSD (GOLD) 

    Minimum 0-5 Signals a Day

    Risk to reward targeted: 1:3 and 1:8

    80% Win Rate

    Signals are copier-friendly 

    Immediately your subscription expires you will be removed.

    Signals are sent immediately with no delay time, we use EA to automatically send our manually taken trades as signals (MT4 to Telegram), Trades are given with screenshots (Tradingview and MT4), and entry, and exit with all trade management is done with updates. EA does reports and percentages recorded. Be assured they’re accurate and transparent. 

    Check FAQ for signal format
  </i>
  
  </blockquote>
    `,
  
  "Mentorship": `<strong>To learn how to be profitable and to learn Greysuitfx Trading strategy</strong>
  <strong>(KTS)</strong>`,
  
  "$10,000 - $49,000":`
  
  <strong> Here are the terms for fund management You're willing to risk 100% of your captital, and are confortable with the risk.
  A $1000 One time fee will be paid for Service Charge. A profit slip structure of 50/50 is obtained.
  ...
  -- Contract Maintainace
  -- Commitment Charge
  
  </blockquote>
  
  <i>By agreeing you will be required to make a one time deposit of $1000 to proceed  to fund management. Send screenshot of payment once you're done</i>
  `,
  ...
  <blockquote>
  <i>The Client invests an amount between $50,000 and $1,000,000 for management by Greysuitfx.
  The Client acknowledges the inherent risks and is willing to risk a specified percentage of their investment. They agree to accept potential losses up to this percentage and will not hold Greysuitfx liable for any losses incurred.</i>
  </blockquote>
  
  <strong>Return on Investment (ROI) Expectation:</strong>
  
  <blockquote>
  <i>The Client expects an ROI of a specified percentage per annum, which Greysuitfx will strive to achieve but does not guarantee.</i>
  </blockquote>
  
  <strong>Liability Waiver:</strong>
  
  <blockquote>
  <i>The Client will not hold Greysuitfx responsible for any losses, damages, or expenses incurred during fund management.</i>
  </blockquote>
  ...
  <blockquote>
  <i>This Agreement is the complete understanding between the Client and Greysuitfx and can only be amended in writing and signed by both parties.</i>
  </blockquote>
  <strong>
  <i>By choosing “agree” the client agrees to the above-stated terms a document will be forwarded to you to complete the agreement procedure and Greysuitfx will reach out to you personally to further discuss the process and answer any further questions.</i>
  </strong>
      `,
